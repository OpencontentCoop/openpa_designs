...
{literal}
$(function() {
	$("#{/literal}argomento-{$node.name|slugize()}{literal}").accordion({ 
		autoHeight: false,		
...
{/literal}
        ...
        <div class="full-block lista_accordion color color-primary">
            <div id="argomento-{$node.name|slugize()}" class="ui-accordion">
        
            {def $first_level_child = $node}
                <div id="{$first_level_child.name|slugize()}" class="ui-accordion-header">
                    <h4>
