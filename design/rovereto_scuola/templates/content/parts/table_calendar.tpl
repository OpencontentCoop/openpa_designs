        ...
        <tbody>
            ...
            {while le( $counter, $days )}
                ...
                {if $day_array|contains(concat(' ', $counter, ',')) }
                    <a href={concat( $calendar.url_alias, "/(day)/", $counter, "/(month)/", $temp_month, "/(year)/", $temp_year)|ezurl} class="has-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Clicca per visualizzare gli eventi">
