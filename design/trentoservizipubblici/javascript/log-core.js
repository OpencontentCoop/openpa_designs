    ...
    function Singleton() {
        ...
        var ctzpLogger = {
            ...
            logQuestionRequest: function (eservice, contentId, questionId) {
                log(ctzpEndpoint + '/questionrequest', {
                    'e-serviceID': eservice,
                    annotableElementID: contentId,
