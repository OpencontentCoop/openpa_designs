{*
	mail di risposta a chi compila il form di valutazione delle pagine del sito
*}
...
{'Collected information'|i18n('design/standard/content/form')} dal sito {ezini('SiteSettings', 'SiteName')}
