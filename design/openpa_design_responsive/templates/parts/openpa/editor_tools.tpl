        ...
        <dl class="dl-horizontal">
            ...
            <dd>
                {*if $node.can_edit}
                  ...
                  <input type="submit" value="{'Set'|i18n( 'design/admin/node/view/full' )}" name="SectionEditButton" class="btn btn-xs" />
                ...
                <dd>
                    {*if $node.can_edit}
                      ...
                      {if $enable_StateEditButton}
                          <input type="submit" value="{'Set'|i18n( 'design/admin/node/view/full' )}" name="StateEditButton" class="btn btn-xs" />
                      {/if}
                    {else*}
                    ...
                    <ul class="list-inline">
                        ...
                        <li>
                            ...
                            <form method="post" action={"content/action"|ezurl}>
                                ...
                                <input type="submit" name="EditButton" class="btn btn-xs btn-default" value="Modifica/inserisci traduzione"/>
                            </form>
                        </li>
                    </ul>
                </dd>
