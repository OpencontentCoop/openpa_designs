...
*}        
        <address>
                ...
                {def $credits = cond( openpaini( 'LinkSpeciali', 'NodoCredits'), fetch( content, node, hash( node_id, openpaini( 'LinkSpeciali', 'NodoCredits') ) ), false())
                     ...
                     $privacy = cond( openpaini( 'LinkSpeciali', 'NodoPrivacy'), fetch( content, node, hash( node_id, openpaini( 'LinkSpeciali', 'NodoPrivacy') ) ), false() )
                ...
                {if $privacy}<a title="Leggi il documento sulla privacy" href={$privacy.url_alias|ezurl()}>privacy</a> - {/if}
