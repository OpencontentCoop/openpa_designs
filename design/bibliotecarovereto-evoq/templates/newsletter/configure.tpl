        ...
        <div class="container">
            <div class="row">
                <div class="newsletter newsletter-subscribe col-xs-12 col-md-12 col-lg-12">
                    <header>
                        <h3>{'Configure newsletter settings'|i18n( 'cjw_newsletter/configure' )}</h3>
                    </header>
                    ...
                    {* for every newsletter_system check if there are newsletter_list where a subscription for current siteaccess is possible *}
                        ...
                        {else}
                                ...
                                <div class="block">
                                    <input class="btn btn-primary pull-right" type="submit" name="ConfirmButton" value="{'Confirm'|i18n( 'cjw_newsletter/configure' )}" title="{'Add to subscription.'|i18n( 'cjw_newsletter/configure' )}" />
                                </div>
