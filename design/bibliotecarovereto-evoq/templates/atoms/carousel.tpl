       ...
       *}
        ...
        *}
        {if and($nav_controls, $items|count()|gt(1))}
          ...
          <a class="carousel-control left hidden-xs" href="#carousel_{$root_node.node_id}" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a>
          <a class="carousel-control right hidden-xs" href="#carousel_{$root_node.node_id}" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
        {/if}
      </div>
