...
{def $css_class = 'col-xs-3'}
{if $vertical}
{set $css_class = 'col-xs-3 col-md-12 col-lg-12'}
{/if}

<div class="row social-buttons">
  <div class="{$css_class} social-button">
  ...
  <div class="{$css_class} social-button{if $vertical} margin-top-5{/if}">
