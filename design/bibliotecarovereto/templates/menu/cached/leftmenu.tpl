...
{def $inimenu = openpaini( 'SideMenu', 'IdentificatoriMenu', array() )
     $_root_node=fetch( 'content', 'node', hash( 'node_id', $root_node_id ) )
     $left_menu_items = fetch( 'content', 'list', hash( 'parent_node_id', $_root_node.node_id,
                                                        'sort_by', $_root_node.sort_array,
                                                        'data_map_load', false(),
