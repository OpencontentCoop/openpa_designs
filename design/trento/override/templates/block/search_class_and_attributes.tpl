...
{def 	
	...
	$node_id_servizi_attivi = ezini( 'Servizi', 'attivi', 'openpa.ini')
	$node_id_servizi_non_attivi = ezini( 'Servizi', 'non_attivi', 'openpa.ini')
	$node_id_argomenti = ezini( 'Argomenti', 'argomenti', 'openpa.ini')
