...
{if is_set( $view_parameters['Tipologia_di_contenuto'] )}
    {def $attributi_da_escludere_dalla_ricerca = ezini( 'GestioneAttributi', 'attributi_da_escludere_dalla_ricerca', 'openpa.ini' )
...
<div class="global-view-full content-view-full">
    ...
    {def $oggetti_correlati_centro = ezini( 'DisplayBlocks', 'oggetti_correlati_centro', 'openpa.ini')
        ...
        <div class="main-column float-break">
            ...
            {if $search_count|gt(0)}
                ...
                <div class="message-feedback">                
                    <h2>
                        {if $search_count|eq(1)}
                        Trovata {$search_count} informazione relative a {$node.name|wash()}
                        {else}
                        Trovate {$search_count} informazioni relative a {$node.name|wash()}
                        {/if}
                    </h2>
                </div>
        ...
        <div class="extrainfo-column" id="extrainfo">
            <div class="border-box">
                ...
                {if useDateFilter}    
                    ...
                    <h3 class="block-title">Data di pubblicazione</h3>
                    <div class="square-box-soft-gray extrainfo-box">
                    <ul class="facet-list">
