...
<tr>
    ...
    {/section}
	    ...
	    {section-else}
            ...
            <td class="bglight">
            {$main_node.object.content_class.name|wash} ({$main_node.class_identifier})
            </td>

            <td class="bglight">
            {fetch( 'section', 'object', hash( 'section_id', $main_node.object.section_id ) ).name|wash()}
            </td>
        </tr>        
        ...
        <tr class="{$Object:sequence}">
            ...
            <td>
                {$Object:item.object.content_class.name|wash} ({$Object:item.class_identifier})
            </td>

            <td>
                {fetch( 'section', 'object', hash( 'section_id', $:item.object.section_id ) ).name|wash()}
            </td>
        </tr>
        {/section}
        </table>
