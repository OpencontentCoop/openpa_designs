...
<div class="attributi-principali float-break col col-notitle">
	<div class="col-content"><div class="col-content-design">
		...
		{elseif and( is_set( $node.data_map.classi_filtro ), $node.data_map.classi_filtro.has_content )}        
            {foreach $node.data_map.classi_filtro.content|explode(',') as $icon}
                {include name=class_icon class_identifier=$icon|trim() uri='design:parts/common/class_icon.tpl' css_class="image-default"}			  
 			{/foreach}
